...
if __name__ == '__main__':
    ...
    radio_difuminacion = 4
    res_difuminar = ordenador.ejecutar_trabajo_en_gpu(DIFUMINAR, vec_base, None, radio_difuminacion)
    ...
    filas = 3
    columnas = 4
    res_difu_mat = ordenador.ejecutar_trabajo_en_gpu(DIFUMINAR_MAT, valores, None, None, filas, columnas)
