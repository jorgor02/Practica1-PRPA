...
class GPU:
    ...
    def ejecutar_trabajo_en_gpu(self, kernel_tipo: int, vector1: list, vector2: list | None = None,
                                filas: int | None = None, columnas: int | None = None, radio: int = 1) -> list:

        self.mem_gpu.kernel.value = kernel_tipo
        self.mem_gpu.res_escalar.value = 0.0 # Para acumular el producto escalar
